    ...
    <div class="pt-14 pb-14 px-4 bg-[#FCCD2A]">
        <div class="content mx-auto relative">
            ...
            <ol class="grid grid-cols-1 sm:grid-rows-1 md:grid-cols-3 gap-6 md:place-items-center">
                <li class="shadow-[0_4px_5px_1px_rgb(0,0,0,0.3)] bg-white px-4 py-4 rounded-xl mb-6 sm:mb-0 md:max-w-72 lg:max-w-80 xl:max-w-100">
            ...
            <div id="timeline" class="md:w-full md:py-14 relative">
                ...
                <div class="md:w-full md:h-1 md:bg-black mx-auto md:relative md:z-0">
                    ...
                    <div class="md:px-4 md:py-4 md:bg-white md:absolute md:rounded-full md:top-1/2 md:transform md:-translate-y-1/2 md:left-[14%]"></div>
