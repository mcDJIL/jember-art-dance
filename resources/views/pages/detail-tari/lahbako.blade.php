            ...
            <div class="relative mb-28 pr-10 rounded-e-[100px] bg-slate-300 pl-10">
                ...
                <div class="flex flex-col md:flex-row items-center gap-5 py-5">
                    ...
                    <p class="text-base sm:text-xl">Busana yang dipakai dalam pertunjukan Tari Lahbako menggambarkan
                        <span class="font-semibold">para penari tembakau</span>. Di bagian kepala, penari memakai <span
                        ...
                        <span class="font-semibold">mengenakan kebaya</span>, dan bagian bawahnya <span
                            ...
                            celemek</span> atau tatakan yang biasa digunakan para petani saat bekerja.
                    </p>
                </div>
            </div>
            ...
            <div class="relative pr-10 rounded-e-[100px] bg-slate-300 pl-10">
                ...
                <div class="flex flex-col md:flex-row gap-5 items-center py-5">
                    ...
                    <p class="text-base sm:text-xl">
                        <span class="font-semibold">- Gerakan Perjalanan dari Rumah menuju
                            Kebun Tembakau</span>: Gerakan ini menggambarkan
                        perjalanan para petani perempuan dari rumah menuju ladang tembakau yang direalisasikan ke
                        dalam gerakan yang anggun. <br><br>
                        <span class="font-semibold">- Gerakan Memetik Daun Tembakau</span>: Gerakan ini menggambarkan
                        aktivitas petani perempuan
                        dalam memetik daun tembakau di ladang. Gerakannya yang lembut dan anggun mencerminkan
                        kesabaran dan ketelitian para petani dalam menjalankan tugasnya. <br><br>
                        <span class="font-semibold">- Gerakan Menjemur Daun Tembakau</span>: Gerakan ini menggambarkan
                        proses penjemuran daun
                        tembakau di bawah sinar matahari. Gerakannya yang dinamis dan berulang-ulang menggambarkan
                        kerja keras para petani dalam mengolah tembakau. <br><br>
                        <span class="font-semibold">- Gerakan Mengepak Tembakau</span>: Gerakan ini menggambarkan proses
                        pengepakan daun tembakau
                        yang telah kering. Gerakannya yang hati-hati dan terukur menunjukkan pentingnya menjaga
                        kualitas tembakau.
                    </p>
                </div>
