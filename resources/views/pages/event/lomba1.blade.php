        ...
        <div class="hero-lomba w-screen">
            <div class="content px-4 mx-auto text-white flex flex-col md:flex-row md:justify-between relative">
                <div class="md:max-w-sm min-[840px]:max-w-lg lg:max-w-2xl">
                    <h1 class="text-4xl font-extrabold pt-20">Lomba Tari Tradisional</h1>
                    <p class="mt-10 font-hind text-lg">Lomba ini diadakan dengan tujuan untuk mengasah kemampuan kesenian
                        para penari muda dan sebagai sarana untuk kolaborasi.</p>
                    ...
                    <div class="mt-10 flex gap-8 flex-wrap">
                        <div class="flex items-center gap-2 text-yellow-300">
                            ...
                            <p class="font-hind text-white">Jember, Kaliwates</p>
                        </div>
                        <div class="flex items-center gap-2 text-yellow-300">
                            <div class="text-3xl">
                                <i class="fa-solid fa-calendar"></i>
                            </div>
                            <p class="font-hind text-white">5 Desember 2024</p>
                        </div>
                        <div class="flex items-center gap-2 text-yellow-300">
                            <div class="text-3xl">
