        ...
        <div class="hero-lomba w-screen">
            <div class="content px-4 mx-auto text-white flex flex-col md:flex-row md:justify-between relative">
                <div class="md:max-w-sm min-[840px]:max-w-lg lg:max-w-2xl">
                    <h1 class="text-4xl font-extrabold pt-20">Pagelaran Wayang Kulit</h1>
                    <p class="mt-10 font-hind text-lg"> Diadakannya Pagelaran Wayang Kulit ini diharapkan mampu membangkitkan
                        eksistensi kesenian wayang kulit yang hampir punah di kalangan para generasi muda zaman
                        sekarang.</p>
                    ...
                    <div class="mt-10 flex gap-8 flex-wrap">
                        <div class="flex items-center gap-2 text-yellow-300">
                            ...
                            <p class="font-hind text-white">Jemberlor, Patrang</p>
                        </div>
                        <div class="flex items-center gap-2 text-yellow-300">
                            <div class="text-3xl">
                                <i class="fa-solid fa-calendar"></i>
                            </div>
                            <p class="font-hind text-white">21 Desember 2024</p>
                        </div>
                        <div class="flex items-center gap-2 text-yellow-300">
                            <div class="text-3xl">
